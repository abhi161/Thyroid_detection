...
class Preprocessor:
    ...
    def encodeCategoricalValues(self,data):
     ...
     # this will map all the rest of the columns as we require. Now for other columns left with more than 2 categories.
    ...
    def handleImbalanceDataset(self,X,Y):
        try:
            ...
            self.logger_object.log(self.file_object, 'Handle Imbalance data Successful. Exited handle_imbalance method of the Preprocessor class')
            return x_sampled,y_sampled

        except Exception as e:
            self.logger_object.log(self.file_object,'Exception occured in handle_imbalance method of the Preprocessor class. Exception message:  ' + str(e))
            self.logger_object.log(self.file_object,'Imbalance data handling failed. Exited the handle_imbalance method of the Preprocessor class')
            raise Exception()
